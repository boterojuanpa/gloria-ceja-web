...
const Hero = () => {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex flex-col justify-between overflow-hidden">
      ...
      {/* Main Content */}
      <div className="relative z-10 flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 pt-20 pb-32">
        <div className="text-center max-w-5xl mx-auto">
          <div className={`transition-all duration-1000 ${isVisible ? 'slide-in-up' : 'opacity-0'}`}>
            ...
            <p className="text-xl sm:text-2xl lg:text-3xl text-white/90 mb-12 max-w-3xl mx-auto leading-relaxed animate-fade-in" style={{animationDelay: '0.6s'}}>
      ...
      <div className="relative z-10 bg-gradient-to-t from-black/80 via-black/40 to-transparent p-8">
